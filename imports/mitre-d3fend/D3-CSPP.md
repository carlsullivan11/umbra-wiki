...
summary: "Comparing client-server request and response payloads to a baseline profile to identify outliers."
sources:
  - name: MITRE D3FEND
    url: https://d3fend.mitre.org/technique/D3-CSPP/
---
...
- [MITRE D3FEND D3-CSPP](https://d3fend.mitre.org/technique/D3-CSPP/)
