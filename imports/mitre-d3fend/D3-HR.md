...
summary: "Initiating a host's reboot sequence to terminate all running processes."
sources:
  - name: MITRE D3FEND
    url: https://d3fend.mitre.org/technique/D3-HR/
---
...
- [MITRE D3FEND D3-HR](https://d3fend.mitre.org/technique/D3-HR/)
