---
slug: defense/D3-PLA
title: "D3-PLA — Process Lineage Analysis"
page_type: defense
...
summary: "Identification of suspicious processes executing on an end-point device by examining the ancestry and siblings of a process, and the associated metadata of each node on the tree, such as process execution, duration, and order relative to siblings and ancestors…"
sources:
  - name: MITRE D3FEND
    url: https://d3fend.mitre.org/technique/D3-PLA/
---
...
- [MITRE D3FEND D3-PLA](https://d3fend.mitre.org/technique/D3-PLA/)
