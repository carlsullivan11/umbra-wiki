---
slug: defense/D3-RTSD
title: "D3-RTSD — Remote Terminal Session Detection"
page_type: defense
...
summary: "Detection of an unauthorized remote live terminal console session by examining network traffic to a network host."
sources:
  - name: MITRE D3FEND
    url: https://d3fend.mitre.org/technique/D3-RTSD/
---
...
- [MITRE D3FEND D3-RTSD](https://d3fend.mitre.org/technique/D3-RTSD/)
