...
summary: "Initiating a host's shutdown sequence to terminate all running processes."
sources:
  - name: MITRE D3FEND
    url: https://d3fend.mitre.org/technique/D3-HS/
---
...
- [MITRE D3FEND D3-HS](https://d3fend.mitre.org/technique/D3-HS/)
