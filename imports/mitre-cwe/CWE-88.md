...
summary: "The product constructs a string for a command to be executed by a separate component in another control sphere, but it does not properly delimit the intended arguments, options, or switches within tha"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/88.html
