...
summary: "The product accepts path input in the form of multiple trailing slash ('/multiple/trailing/slash//') without appropriate validation, which can lead to ambiguous path resolution and allow an attacker t"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/52.html
