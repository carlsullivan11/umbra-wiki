...
summary: "The product includes web functionality (such as a web widget) from another domain, which causes it to operate within the domain of the product, potentially granting total access and control of the pro"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/830.html
