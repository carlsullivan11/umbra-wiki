...
summary: "The product performs operations on a memory buffer, but it reads from or writes to a memory location outside the buffer's intended boundary. This may result in read or write operations on unexpected m"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/119.html
