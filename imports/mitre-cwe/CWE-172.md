...
summary: "The product does not properly encode or decode the data, resulting in unexpected values."
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/172.html
