...
summary: "The product has or supports multiple distributed components or sub-systems that are each required to keep their own local copy of shared data - such as state or cache - but the product does not ensure"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/1250.html
