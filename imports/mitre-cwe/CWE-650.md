...
summary: "The server contains a protection mechanism that assumes that any URI that is accessed using HTTP GET will not cause a state change to the associated resource. This might allow attackers to bypass inte"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/650.html
