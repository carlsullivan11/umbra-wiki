...
summary: "The product constructs a log message from external input, but it does not neutralize or incorrectly neutralizes special elements when the message is written to a log file."
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/117.html
