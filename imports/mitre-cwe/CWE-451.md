...
summary: "The user interface (UI) does not properly represent critical information to the user, allowing the information - or its source - to be obscured or spoofed. This is often a component in phishing attack"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/451.html
