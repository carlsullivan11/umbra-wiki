...
summary: "The web application improperly neutralizes user-controlled input for executable script disguised with URI encodings."
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/84.html
