...
summary: "The product makes invalid assumptions about how protocol data or memory is organized at a lower level, resulting in unintended program behavior."
sources:
  - name: MITRE CWE
...
**Implementation** — In flat address space situations, never allow computing memory addresses as offsets from another memory address.
...
- CWE page: https://cwe.mitre.org/data/definitions/188.html
