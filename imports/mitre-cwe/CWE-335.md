...
summary: "The product uses a Pseudo-Random Number Generator (PRNG) but does not correctly manage seeds."
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/335.html
