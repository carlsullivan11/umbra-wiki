...
summary: "The product receives input from an upstream component, but it does not neutralize or incorrectly neutralizes leading special elements that could be interpreted in unexpected ways when they are sent to"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/160.html
