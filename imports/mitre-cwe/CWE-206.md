...
summary: "The product performs multiple behaviors that are combined to produce a single result, but the individual behaviors are observable separately in a way that allows attackers to reveal internal state or "
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/206.html
