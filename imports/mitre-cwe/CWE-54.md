...
summary: "The product accepts path input in the form of trailing backslash ('filedir\') without appropriate validation, which can lead to ambiguous path resolution and allow an attacker to traverse the file sys"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/54.html
