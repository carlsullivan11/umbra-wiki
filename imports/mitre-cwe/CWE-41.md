...
summary: "The product is vulnerable to file system contents disclosure through path equivalence. Path equivalence involves the use of special characters in file and directory names. The associated manipulations"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/41.html
