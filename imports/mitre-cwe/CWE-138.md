...
summary: "The product receives input from an upstream component, but it does not neutralize or incorrectly neutralizes special elements that could be interpreted as control elements or syntactic markers when th"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/138.html
