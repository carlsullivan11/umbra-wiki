...
summary: "The product does not neutralize or incorrectly neutralizes user-controlled input for alternate script syntax."
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/87.html
