...
summary: "The product receives data from an HTTP agent/component (e.g., web server, proxy, browser, etc.), but it does not neutralize or incorrectly neutralizes CR and LF characters before the data is included "
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/113.html
