...
summary: "The product receives input from an upstream component, but it does not neutralize or incorrectly neutralizes special elements that could be interpreted as macro symbols when they are sent to a downstr"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/152.html
