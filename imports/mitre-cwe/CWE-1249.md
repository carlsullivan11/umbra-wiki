...
summary: "The product provides an application for administrators to manage parts of the underlying operating system, but the application does not accurately identify all of the relevant entities or resources th"
sources:
  - name: MITRE CWE
...
- CWE page: https://cwe.mitre.org/data/definitions/1249.html
