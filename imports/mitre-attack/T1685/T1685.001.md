---
slug: technique/T1685.001
title: "T1685.001 — Disable or Modify Windows Event Log"
page_type: technique
...
summary: "Adversaries may disable or modify the Windows Event Log to limit data that can be leveraged for detections and audits. Windows Event Log records user and system activity such as login attempts and pro"
sources:
  - name: MITRE ATT&CK
...
- ATT&CK page: https://attack.mitre.org/techniques/T1685/001
